        ...
        <div className="flex">
              ...
              <div className="text-left p-3">
                ...
                <ul className="list-decimal text-gray-600">
                  <li>
                    ...
                    Fugiat dolores praesentium quae culpa eos nesciunt sunt,
                    laudantium dolorum a odio porro ipsa, voluptatibus
                    architecto iste suscipit laborum numquam impedit in.
                  </li>
                  <li>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Beatae voluptates cumque asperiores nulla maiores explicabo
                    accusamus, ullam dignissimos, tempora repudiandae
                    consectetur cupiditate sint animi dolore ab eveniet
                    perspiciatis ipsam id.
                  </li>
                  <li>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Quos autem quis quia unde perferendis aperiam repellendus
                    cupiditate nemo odio, mollitia recusandae deserunt iste ea
                    rem, harum aut blanditiis molestiae! Nulla?
                  </li>
                </ul>
              </div>
          ...
          <div className="h-screen w-2/3 overflow-scroll p-7">
            ...
            <div className="flex h-6 items-center mt-3 shadow-md p-9">
              ...
              <div className="text-sm leading-6 ml-3">
                <p className="text-gray-500">
                  Check this box if you want to allow candidates to attempt test
                  multiple times
                </p>
              </div>
            </div>
            ...
            <div className="flex space-between">
              <button className="mt-3 p-2 flex-auto rounded-none  bg-indigo-600 text-white lg">
                Next
              </button>
              <button className="mt-3 ml-3 p-2 flex-auto rounded-none  bg-indigo-600 text-white lg">
                Previous
              </button>
            </div>
          </div>
